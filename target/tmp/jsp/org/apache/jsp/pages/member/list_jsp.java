 ...
 * Generated at: 2019-04-20 05:49:48 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.pages.member;
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<title>会员列表-WeAdmin Frame型后台管理系统-WeAdmin 1.0</title>\n");
      ...
      out.write("\t\t\t\t<button class=\"layui-btn\" onclick=\"WeAdminShow('添加用户','./add.html',600,400)\"><i class=\"layui-icon\"></i>添加</button>\n");
      out.write("\t\t\t\t<span class=\"fr\" style=\"line-height:40px\">共有数据：88 条</span>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<table class=\"layui-table\" id=\"memberList\">\n");
      out.write("\t\t\t\t<thead>\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<th>\n");
      ...
      out.write("\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"layui-unselect layui-form-checkbox\" lay-skin=\"primary\" data-id=\"1\"><i class=\"layui-icon\">&#xe605;</i></div>\n");
      out.write("\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t<td>1</td>\n");
      out.write("\t\t\t\t\t\t<td>小张</td>\n");
      out.write("\t\t\t\t\t\t<td>男</td>\n");
      out.write("\t\t\t\t\t\t<td>17600000000</td>\n");
      ...
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t<a title=\"编辑\" onclick=\"WeAdminEdit('编辑','./edit.html', 1, 600, 400)\" href=\"javascript:;\">\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\"layui-icon\">&#xe642;</i>\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t<a onclick=\"WeAdminShow('修改密码','./password.html',600,400)\" title=\"修改密码\" href=\"javascript:;\">\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\"layui-icon\">&#xe631;</i>\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<i class=\"layui-icon\">&#xe601;</i>\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t<a title=\"编辑\" onclick=\"WeAdminEdit('编辑','./edit.html', 2, 600, 400)\" href=\"javascript:;\">\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\"layui-icon\">&#xe642;</i>\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t<a onclick=\"WeAdminShow('修改密码','./password.html',600,400)\" title=\"修改密码\" href=\"javascript:;\">\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\"layui-icon\">&#xe631;</i>\n");
